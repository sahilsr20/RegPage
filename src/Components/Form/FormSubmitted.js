...
const FormSubmitted = () => {
  return <div className={FSubCss.fOnemDiv}>
    <div className={FSubCss.mCOnDiv}>
      <p className={FSubCss.ThanksP}>Thanks for apibus vitae blandit nisl massa habitasse. Dignissim enim, vitae, massa consectetur!!</p>
